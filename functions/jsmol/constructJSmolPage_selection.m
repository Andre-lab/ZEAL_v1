function [] = constructJSmolPage_selection(JSmolPagePath, width, height, structureName, webGLOp)
...
scriptStr = sprintf('set antialiasDisplay; load ./tmp/%s; background {0.94, 0.94, 0.94}; set picking select group; set pickingstyle select drag; selectionHalos ON', structureName);
